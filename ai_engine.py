...
def get_ai_hint_stream(question: str, user_attempt: str, mapel: str = "Umum"):
    ...
    Instruksi:
    - MAKSIMAL 350 KATA.
    - Jangan berikan salam pembuka yang terlalu berlebihan.
...
def get_ai_solution_stream(question: str, correct_answer: str, mapel: str = "Umum"):
    ...
    - Sampaikan dahulu soal nomor berapa yg akan di bahas kemudian Langsung menuju langkah langkah penyelesaiannya.
